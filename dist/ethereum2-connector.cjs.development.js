...
var NoEthereumProviderError = /*#__PURE__*/function (_Error) {
  ...
  function NoEthereumProviderError() {
    ...
    _this.message = 'No Ethereum provider was found on window.ethereum2.';
    return _this;
  }
...
var Ethereum2Connector = /*#__PURE__*/function (_AbstractConnector) {
  _inheritsLoose(Ethereum2Connector, _AbstractConnector);

  function Ethereum2Connector(kwargs) {
    var _this3;
  ...
  _proto.activate = function activate() {
    try {
      ...
      var _temp5 = function _temp5(_result) {
        ...
        var _temp = function () {
          if (!account) {
            ...
            return Promise.resolve(window.ethereum2.enable().then(function (sendReturn) {
              return sendReturn && parseSendReturn(sendReturn)[0];
            })).then(function (_window$ethereum2$ena) {
              account = _window$ethereum2$ena;
            });
          }
        }();
      ...
      if (window.ethereum2.on) {
        window.ethereum2.on('chainChanged', _this5.handleChainChanged);
        window.ethereum2.on('accountsChanged', _this5.handleAccountsChanged);
        window.ethereum2.on('close', _this5.handleClose);
        window.ethereum2.on('networkChanged', _this5.handleNetworkChanged);
      }

      if (window.ethereum2.isMetaMask) {
        ;
        window.ethereum2.autoRefreshOnNetworkChange = false;
      ...
      var _temp6 = _catch(function () {
        return Promise.resolve(window.ethereum2.send('eth_requestAccounts').then(function (sendReturn) {
          return parseSendReturn(sendReturn)[0];
        })).then(function (_window$ethereum2$sen) {
          account = _window$ethereum2$sen;
        });
      }, function (error) {
        if (error.code === 4001) {
  ...
  _proto.getProvider = function getProvider() {
    try {
      return Promise.resolve(window.ethereum2);
    } catch (e) {
      return Promise.reject(e);
    }
  };
    ...
    try {
      var _temp13 = function _temp13() {
        function _temp9() {
          if (!chainId) {
            try {
              chainId = parseSendReturn(window.ethereum2.send({
                method: 'net_version'
              }));
            } catch (_unused) {
          ...
          if (!chainId) {
            if (window.ethereum2.isDapper) {
              chainId = parseSendReturn(window.ethereum2.cachedResults.net_version);
            } else {
              chainId = window.ethereum2.chainId || window.ethereum2.netVersion || window.ethereum2.networkVersion || window.ethereum2._chainId;
            }
          }
        ...
        var _temp8 = function () {
          if (!chainId) {
            var _temp12 = _catch(function () {
              return Promise.resolve(window.ethereum2.send('net_version').then(parseSendReturn)).then(function (_window$ethereum2$sen3) {
      ...
      var _temp14 = _catch(function () {
        return Promise.resolve(window.ethereum2.send('eth_chainId').then(parseSendReturn)).then(function (_window$ethereum2$sen2) {
  ...
  _proto.getAccount = function getAccount() {
    try {
      var _temp21 = function _temp21() {
        function _temp17() {
          if (!account) {
            account = parseSendReturn(window.ethereum2.send({
              method: 'eth_accounts'
            }))[0];
          }
        ...
        var _temp16 = function () {
          if (!account) {
            var _temp20 = _catch(function () {
              return Promise.resolve(window.ethereum2.enable().then(function (sendReturn) {
                return parseSendReturn(sendReturn)[0];
              })).then(function (_window$ethereum2$ena2) {
      ...
      var _temp22 = _catch(function () {
        return Promise.resolve(window.ethereum2.send('eth_accounts').then(function (sendReturn) {
          return parseSendReturn(sendReturn)[0];
        })).then(function (_window$ethereum2$sen4) {
...
//# sourceMappingURL=ethereum2-connector.cjs.development.js.map
